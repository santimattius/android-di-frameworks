package com.santimattius.basic.di.mockwebserver

import com.santimattius.basic.di.core.network.RetrofitServiceCreator
import com.santimattius.basic.di.tools.helpers.JsonLoader
...
class MockWebServerExampleTest {
    ...
    fun setup() {
        ...
        service = serviceCreator.create(ExampleService::class)
    }
